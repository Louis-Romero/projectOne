#Louis Paul Romero
#Date Last Modified:  February 15, 2016
#Temporal Median Filter On a Series of Images
#https://github.com/Louis-Romero/projectOne.git 

import sys 

#MEDIAN FILTER ON 9 IMAGES FOR GRADE IN CLASS
def createNewPicture():
  ...
  #CREATES AN ARRAY WITH EACH ELEMENT CONTAINING SPECIFIED IMAGE
  for ix in range(0,9):
    allPictures.append(makePicture(getMediaPath(str((ix+1)) + ".jpg")))
...
def displayMenu():
  ...
  print "Enter 7 to filter NEW PICTURES:"
...
def main():
  ...
  if(choice == 1):
    ...
    standardImage = createNewPicture()
    show(standardImage)
    saveNewImage(standardImage)
